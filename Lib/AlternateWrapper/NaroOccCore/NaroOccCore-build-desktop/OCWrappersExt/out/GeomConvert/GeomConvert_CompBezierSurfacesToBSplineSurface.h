...
//
#ifndef _GeomConvert_CompBezierSurfacesToBSplineSurface_OCWrappers_HeaderFile
#define _GeomConvert_CompBezierSurfacesToBSplineSurface_OCWrappers_HeaderFile
...
public ref class OCGeomConvert_CompBezierSurfacesToBSplineSurface  {

protected:
  GeomConvert_CompBezierSurfacesToBSplineSurface* nativeHandle;
  OCGeomConvert_CompBezierSurfacesToBSplineSurface(OCDummy^) {};

public:
  property GeomConvert_CompBezierSurfacesToBSplineSurface* Handle
  {
...
OCGeomConvert_CompBezierSurfacesToBSplineSurface(GeomConvert_CompBezierSurfacesToBSplineSurface* nativeHandle);
...
OCGeomConvert_CompBezierSurfacesToBSplineSurface(OCNaroWrappers::OCTColGeom_Array2OfBezierSurface^ Beziers);
...
OCGeomConvert_CompBezierSurfacesToBSplineSurface(OCNaroWrappers::OCTColGeom_Array2OfBezierSurface^ Beziers, Standard_Real Tolerance, System::Boolean RemoveKnots);
...
OCGeomConvert_CompBezierSurfacesToBSplineSurface(OCNaroWrappers::OCTColGeom_Array2OfBezierSurface^ Beziers, OCNaroWrappers::OCTColStd_Array1OfReal^ UKnots, OCNaroWrappers::OCTColStd_Array1OfReal^ VKnots, OCGeomAbs_Shape UContinuity, OCGeomAbs_Shape VContinuity, Standard_Real Tolerance);
...
~OCGeomConvert_CompBezierSurfacesToBSplineSurface()
{
  delete nativeHandle;
}
