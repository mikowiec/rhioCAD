...
//
#ifndef _GeomConvert_BSplineCurveKnotSplitting_OCWrappers_HeaderFile
#define _GeomConvert_BSplineCurveKnotSplitting_OCWrappers_HeaderFile
...
public ref class OCGeomConvert_BSplineCurveKnotSplitting  {

protected:
  GeomConvert_BSplineCurveKnotSplitting* nativeHandle;
  OCGeomConvert_BSplineCurveKnotSplitting(OCDummy^) {};

public:
  property GeomConvert_BSplineCurveKnotSplitting* Handle
  {
...
OCGeomConvert_BSplineCurveKnotSplitting(GeomConvert_BSplineCurveKnotSplitting* nativeHandle);
...
OCGeomConvert_BSplineCurveKnotSplitting(OCNaroWrappers::OCGeom_BSplineCurve^ BasisCurve, Standard_Integer ContinuityRange);
...
~OCGeomConvert_BSplineCurveKnotSplitting()
{
  delete nativeHandle;
}
