...
//
#ifndef _GProp_GProps_OCWrappers_HeaderFile
#define _GProp_GProps_OCWrappers_HeaderFile
...
ref class OCgp_Mat;
ref class OCgp_Ax1;
ref class OCGProp_PrincipalProps;
...
public ref class OCGProp_GProps  {

protected:
  GProp_GProps* nativeHandle;
  OCGProp_GProps(OCDummy^) {};

public:
  property GProp_GProps* Handle
  {
    GProp_GProps* get()
    {
      return nativeHandle;
...
OCGProp_GProps(GProp_GProps* nativeHandle);
...
OCGProp_GProps(OCNaroWrappers::OCgp_Pnt^ SystemLocation);
...
//! equal to gp::Resolution(). <br>
 /*instead*/  void Add(OCNaroWrappers::OCGProp_GProps^ Item, Standard_Real Density) ;
...
//!  (you can use the method of package GProp : HOperator). <br>
 /*instead*/  OCgp_Mat^ MatrixOfInertia() ;
...
//! three axes of the Cartesian coordinate system. <br>
 /*instead*/  void StaticMoments(Standard_Real& Ix, Standard_Real& Iy, Standard_Real& Iz) ;


//!  computes the moment of inertia of the material system about the <br>
//!  axis A. <br>
 /*instead*/  Standard_Real MomentOfInertia(OCNaroWrappers::OCgp_Ax1^ A) ;
...
//! queried to access the value sought. <br>
 /*instead*/  OCGProp_PrincipalProps^ PrincipalProperties() ;

//! Returns the radius of gyration of the current system about the axis A. <br>
 /*instead*/  Standard_Real RadiusOfGyration(OCNaroWrappers::OCgp_Ax1^ A) ;
