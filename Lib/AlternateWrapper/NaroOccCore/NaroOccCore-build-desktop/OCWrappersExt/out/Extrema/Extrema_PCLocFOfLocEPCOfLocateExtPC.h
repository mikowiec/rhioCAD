...
//
#ifndef _Extrema_PCLocFOfLocEPCOfLocateExtPC_OCWrappers_HeaderFile
#define _Extrema_PCLocFOfLocEPCOfLocateExtPC_OCWrappers_HeaderFile
...
public ref class OCExtrema_PCLocFOfLocEPCOfLocateExtPC  : public OCmath_FunctionWithDerivative {

protected:
  // dummy constructor;
  OCExtrema_PCLocFOfLocEPCOfLocateExtPC(OCDummy^) : OCmath_FunctionWithDerivative((OCDummy^)nullptr) {};

public:

// constructor from native
OCExtrema_PCLocFOfLocEPCOfLocateExtPC(Extrema_PCLocFOfLocEPCOfLocateExtPC* nativeHandle);
...
OCExtrema_PCLocFOfLocEPCOfLocateExtPC(OCNaroWrappers::OCgp_Pnt^ P, OCNaroWrappers::OCAdaptor3d_Curve^ C);
