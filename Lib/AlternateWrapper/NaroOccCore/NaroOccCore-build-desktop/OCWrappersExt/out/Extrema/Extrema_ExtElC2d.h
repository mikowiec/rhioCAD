...
//
#ifndef _Extrema_ExtElC2d_OCWrappers_HeaderFile
#define _Extrema_ExtElC2d_OCWrappers_HeaderFile
...
public ref class OCExtrema_ExtElC2d  {

protected:
  Extrema_ExtElC2d* nativeHandle;
  OCExtrema_ExtElC2d(OCDummy^) {};

public:
  property Extrema_ExtElC2d* Handle
  {
...
OCExtrema_ExtElC2d(Extrema_ExtElC2d* nativeHandle);
...
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Lin2d^ C1, OCNaroWrappers::OCgp_Lin2d^ C2, Standard_Real AngTol);

//! Calculates the distance between a line and a <br>
//!          circle. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Lin2d^ C1, OCNaroWrappers::OCgp_Circ2d^ C2, Standard_Real Tol);

//! Calculates the distance between a line and an <br>
//!          elipse. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Lin2d^ C1, OCNaroWrappers::OCgp_Elips2d^ C2);

//! Calculates the distance between a line and a <br>
//!          hyperbola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Lin2d^ C1, OCNaroWrappers::OCgp_Hypr2d^ C2);

//! Calculates the distance between a line and a <br>
//!          parabola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Lin2d^ C1, OCNaroWrappers::OCgp_Parab2d^ C2);

//! Calculates the distance between two circles. <br>
//!          The circles can be parallel or identical. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Circ2d^ C1, OCNaroWrappers::OCgp_Circ2d^ C2);

//! Calculates the distance between a circle and an <br>
//!          elipse. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Circ2d^ C1, OCNaroWrappers::OCgp_Elips2d^ C2);

//! Calculates the distance between a circle and a <br>
//!          hyperbola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Circ2d^ C1, OCNaroWrappers::OCgp_Hypr2d^ C2);

//! Calculates the distance between a circle and a <br>
//!          parabola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Circ2d^ C1, OCNaroWrappers::OCgp_Parab2d^ C2);

//! Calculates the distance between two elipses. <br>
//!          The elipses can be parallel or identical. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Elips2d^ C1, OCNaroWrappers::OCgp_Elips2d^ C2);

//! Calculates the distance between an elipse and a <br>
//!          hyperbola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Elips2d^ C1, OCNaroWrappers::OCgp_Hypr2d^ C2);

//! Calculates the distance between an elipse and a <br>
//!          parabola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Elips2d^ C1, OCNaroWrappers::OCgp_Parab2d^ C2);

//! Calculates the distance between two hyperbolas. <br>
//!          The hyperbolas can be parallel or identical. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Hypr2d^ C1, OCNaroWrappers::OCgp_Hypr2d^ C2);

//! Calculates the distance between a hyperbola and a <br>
//!          parabola. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Hypr2d^ C1, OCNaroWrappers::OCgp_Parab2d^ C2);

//! Calculates the distance between two parabolas <br>
//!          The parabolas can be parallel or identical. <br>
OCExtrema_ExtElC2d(OCNaroWrappers::OCgp_Parab2d^ C1, OCNaroWrappers::OCgp_Parab2d^ C2);
