...
//
#ifndef _Extrema_PCLocFOfLocEPCOfLocateExtPC2d_OCWrappers_HeaderFile
#define _Extrema_PCLocFOfLocEPCOfLocateExtPC2d_OCWrappers_HeaderFile
...
public ref class OCExtrema_PCLocFOfLocEPCOfLocateExtPC2d  : public OCmath_FunctionWithDerivative {

protected:
  // dummy constructor;
  OCExtrema_PCLocFOfLocEPCOfLocateExtPC2d(OCDummy^) : OCmath_FunctionWithDerivative((OCDummy^)nullptr) {};

public:

// constructor from native
OCExtrema_PCLocFOfLocEPCOfLocateExtPC2d(Extrema_PCLocFOfLocEPCOfLocateExtPC2d* nativeHandle);
...
OCExtrema_PCLocFOfLocEPCOfLocateExtPC2d(OCNaroWrappers::OCgp_Pnt2d^ P, OCNaroWrappers::OCAdaptor2d_Curve2d^ C);
