...
//
#ifndef _BRepLProp_CurveTool_OCWrappers_HeaderFile
#define _BRepLProp_CurveTool_OCWrappers_HeaderFile
...
public ref class OCBRepLProp_CurveTool  {

protected:
  BRepLProp_CurveTool* nativeHandle;
  OCBRepLProp_CurveTool(OCDummy^) {};

public:
  property BRepLProp_CurveTool* Handle
  {
...
OCBRepLProp_CurveTool(BRepLProp_CurveTool* nativeHandle);

// Methods PUBLIC

//! Computes the point <P> of parameter <U> on the curve <C>. <br>
static /*instead*/  void Value(OCNaroWrappers::OCBRepAdaptor_Curve^ C, Standard_Real U, OCNaroWrappers::OCgp_Pnt^ P) ;
...
static /*instead*/  void D2(OCNaroWrappers::OCBRepAdaptor_Curve^ C, Standard_Real U, OCNaroWrappers::OCgp_Pnt^ P, OCNaroWrappers::OCgp_Vec^ V1, OCNaroWrappers::OCgp_Vec^ V2) ;

//! Computes the point <P>, the first derivative <V1>, the <br>
//!          second derivative <V2> and third derivative <V3> of <br>
//!          parameter <U> on the curve <C>. <br>
static /*instead*/  void D3(OCNaroWrappers::OCBRepAdaptor_Curve^ C, Standard_Real U, OCNaroWrappers::OCgp_Pnt^ P, OCNaroWrappers::OCgp_Vec^ V1, OCNaroWrappers::OCgp_Vec^ V2, OCNaroWrappers::OCgp_Vec^ V3) ;
...
static /*instead*/  Standard_Integer Continuity(OCNaroWrappers::OCBRepAdaptor_Curve^ C) ;
