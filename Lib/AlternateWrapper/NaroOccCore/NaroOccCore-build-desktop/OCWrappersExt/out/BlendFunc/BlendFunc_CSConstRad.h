...
//
#ifndef _BlendFunc_CSConstRad_OCWrappers_HeaderFile
#define _BlendFunc_CSConstRad_OCWrappers_HeaderFile
...
public ref class OCBlendFunc_CSConstRad  : public OCBlend_CSFunction {

protected:
  // dummy constructor;
  OCBlendFunc_CSConstRad(OCDummy^) : OCBlend_CSFunction((OCDummy^)nullptr) {};

public:

// constructor from native
OCBlendFunc_CSConstRad(BlendFunc_CSConstRad* nativeHandle);

// Methods PUBLIC


OCBlendFunc_CSConstRad(OCNaroWrappers::OCAdaptor3d_HSurface^ S, OCNaroWrappers::OCAdaptor3d_HCurve^ C, OCNaroWrappers::OCAdaptor3d_HCurve^ CGuide);
