...
//
#ifndef _BlendFunc_ConstRadInv_OCWrappers_HeaderFile
#define _BlendFunc_ConstRadInv_OCWrappers_HeaderFile
...
public ref class OCBlendFunc_ConstRadInv  : public OCBlend_FuncInv {

protected:
  // dummy constructor;
  OCBlendFunc_ConstRadInv(OCDummy^) : OCBlend_FuncInv((OCDummy^)nullptr) {};

public:

// constructor from native
OCBlendFunc_ConstRadInv(BlendFunc_ConstRadInv* nativeHandle);

// Methods PUBLIC


OCBlendFunc_ConstRadInv(OCNaroWrappers::OCAdaptor3d_HSurface^ S1, OCNaroWrappers::OCAdaptor3d_HSurface^ S2, OCNaroWrappers::OCAdaptor3d_HCurve^ C);
