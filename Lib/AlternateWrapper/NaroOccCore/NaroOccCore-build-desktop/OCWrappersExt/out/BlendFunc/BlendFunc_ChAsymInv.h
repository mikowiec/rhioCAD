...
//
#ifndef _BlendFunc_ChAsymInv_OCWrappers_HeaderFile
#define _BlendFunc_ChAsymInv_OCWrappers_HeaderFile
...
public ref class OCBlendFunc_ChAsymInv  : public OCBlend_FuncInv {

protected:
  // dummy constructor;
  OCBlendFunc_ChAsymInv(OCDummy^) : OCBlend_FuncInv((OCDummy^)nullptr) {};

public:

// constructor from native
OCBlendFunc_ChAsymInv(BlendFunc_ChAsymInv* nativeHandle);

// Methods PUBLIC


OCBlendFunc_ChAsymInv(OCNaroWrappers::OCAdaptor3d_HSurface^ S1, OCNaroWrappers::OCAdaptor3d_HSurface^ S2, OCNaroWrappers::OCAdaptor3d_HCurve^ C);
