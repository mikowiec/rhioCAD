...
//
#ifndef _BlendFunc_ConstRad_OCWrappers_HeaderFile
#define _BlendFunc_ConstRad_OCWrappers_HeaderFile
...
public ref class OCBlendFunc_ConstRad  : public OCBlend_Function {

protected:
  // dummy constructor;
  OCBlendFunc_ConstRad(OCDummy^) : OCBlend_Function((OCDummy^)nullptr) {};

public:

// constructor from native
OCBlendFunc_ConstRad(BlendFunc_ConstRad* nativeHandle);

// Methods PUBLIC


OCBlendFunc_ConstRad(OCNaroWrappers::OCAdaptor3d_HSurface^ S1, OCNaroWrappers::OCAdaptor3d_HSurface^ S2, OCNaroWrappers::OCAdaptor3d_HCurve^ C);
