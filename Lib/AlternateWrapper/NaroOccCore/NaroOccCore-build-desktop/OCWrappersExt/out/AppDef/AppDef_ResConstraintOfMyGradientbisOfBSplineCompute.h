...
//
#ifndef _AppDef_ResConstraintOfMyGradientbisOfBSplineCompute_OCWrappers_HeaderFile
#define _AppDef_ResConstraintOfMyGradientbisOfBSplineCompute_OCWrappers_HeaderFile
...
public ref class OCAppDef_ResConstraintOfMyGradientbisOfBSplineCompute  {

protected:
  AppDef_ResConstraintOfMyGradientbisOfBSplineCompute* nativeHandle;
  OCAppDef_ResConstraintOfMyGradientbisOfBSplineCompute(OCDummy^) {};

public:
  property AppDef_ResConstraintOfMyGradientbisOfBSplineCompute* Handle
  {
    AppDef_ResConstraintOfMyGradientbisOfBSplineCompute* get()
    {
      return nativeHandle;
    }
  }
