...
//
#ifndef _AppDef_TheResol_OCWrappers_HeaderFile
#define _AppDef_TheResol_OCWrappers_HeaderFile
...
public ref class OCAppDef_TheResol  {

protected:
  AppDef_TheResol* nativeHandle;
  OCAppDef_TheResol(OCDummy^) {};

public:
  property AppDef_TheResol* Handle
  {
    AppDef_TheResol* get()
    {
      return nativeHandle;
