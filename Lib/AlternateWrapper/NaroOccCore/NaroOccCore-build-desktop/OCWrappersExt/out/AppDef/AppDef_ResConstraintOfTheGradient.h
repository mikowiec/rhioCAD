...
//
#ifndef _AppDef_ResConstraintOfTheGradient_OCWrappers_HeaderFile
#define _AppDef_ResConstraintOfTheGradient_OCWrappers_HeaderFile
...
public ref class OCAppDef_ResConstraintOfTheGradient  {

protected:
  AppDef_ResConstraintOfTheGradient* nativeHandle;
  OCAppDef_ResConstraintOfTheGradient(OCDummy^) {};

public:
  property AppDef_ResConstraintOfTheGradient* Handle
  {
    AppDef_ResConstraintOfTheGradient* get()
    {
      return nativeHandle;
    }
  }
