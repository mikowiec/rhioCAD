...
//
#ifndef _IntCurveSurface_TheHSurfaceTool_OCWrappers_HeaderFile
#define _IntCurveSurface_TheHSurfaceTool_OCWrappers_HeaderFile
...
public ref class OCIntCurveSurface_TheHSurfaceTool  {

protected:
  IntCurveSurface_TheHSurfaceTool* nativeHandle;
  OCIntCurveSurface_TheHSurfaceTool(OCDummy^) {};

public:
  property IntCurveSurface_TheHSurfaceTool* Handle
  {
    IntCurveSurface_TheHSurfaceTool* get()
    {
      return nativeHandle;
    }
  }
...
OCIntCurveSurface_TheHSurfaceTool(IntCurveSurface_TheHSurfaceTool* nativeHandle);
...
static /*instead*/  OCAdaptor3d_HSurface^ BasisSurface(OCNaroWrappers::OCAdaptor3d_HSurface^ S) ;


static /*instead*/  Standard_Real OffsetValue(OCNaroWrappers::OCAdaptor3d_HSurface^ S) ;
...
~OCIntCurveSurface_TheHSurfaceTool()
{
  delete nativeHandle;
}
