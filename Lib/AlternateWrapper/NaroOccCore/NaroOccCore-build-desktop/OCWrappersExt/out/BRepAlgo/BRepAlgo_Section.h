...
//
#ifndef _BRepAlgo_Section_OCWrappers_HeaderFile
#define _BRepAlgo_Section_OCWrappers_HeaderFile
...
public ref class OCBRepAlgo_Section  : public OCBRepAlgo_BooleanOperation {

protected:
  // dummy constructor;
  OCBRepAlgo_Section(OCDummy^) : OCBRepAlgo_BooleanOperation((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepAlgo_Section(BRepAlgo_Section* nativeHandle);

// Methods PUBLIC


OCBRepAlgo_Section(OCNaroWrappers::OCTopoDS_Shape^ Sh1, OCNaroWrappers::OCTopoDS_Shape^ Sh2, System::Boolean PerformNow);


OCBRepAlgo_Section(OCNaroWrappers::OCTopoDS_Shape^ Sh, OCNaroWrappers::OCgp_Pln^ Pl, System::Boolean PerformNow);


OCBRepAlgo_Section(OCNaroWrappers::OCTopoDS_Shape^ Sh, OCNaroWrappers::OCGeom_Surface^ Sf, System::Boolean PerformNow);


OCBRepAlgo_Section(OCNaroWrappers::OCGeom_Surface^ Sf, OCNaroWrappers::OCTopoDS_Shape^ Sh, System::Boolean PerformNow);
...
//! S.Build(); <br>
//! TopoDS_Shape R = S.Shape(); <br>
OCBRepAlgo_Section(OCNaroWrappers::OCGeom_Surface^ Sf1, OCNaroWrappers::OCGeom_Surface^ Sf2, System::Boolean PerformNow);
