...
//
#ifndef _BRepBuilderAPI_MakeFace_OCWrappers_HeaderFile
#define _BRepBuilderAPI_MakeFace_OCWrappers_HeaderFile
...
#include "BRepBuilderAPI_MakeShape.h"
#include "BRepBuilderAPI_FaceError.h"
...
public ref class OCBRepBuilderAPI_MakeFace  : public OCBRepBuilderAPI_MakeShape {

protected:
  // dummy constructor;
  OCBRepBuilderAPI_MakeFace(OCDummy^) : OCBRepBuilderAPI_MakeShape((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepBuilderAPI_MakeFace(BRepBuilderAPI_MakeFace* nativeHandle);

// Methods PUBLIC

//! Not done. <br>
OCBRepBuilderAPI_MakeFace();

//! Load a face. Usefull to add wires. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCTopoDS_Face^ F);

//! Make a face from a plane. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Pln^ P);

//! Make a face from a cylinder. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Cylinder^ C);

//! Make a face from a cone. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Cone^ C);

//! Make a face from a sphere. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Sphere^ S);

//! Make a face from a torus. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Torus^ C);

//! Make a face from a Surface. Accepts tolerance value (TolDegen) <br>
//! for resolution of degenerated edges. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCGeom_Surface^ S, Standard_Real TolDegen);

//! Make a face from a plane. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Pln^ P, Standard_Real UMin, Standard_Real UMax, Standard_Real VMin, Standard_Real VMax);

//! Make a face from a cylinder. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Cylinder^ C, Standard_Real UMin, Standard_Real UMax, Standard_Real VMin, Standard_Real VMax);

//! Make a face from a cone. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Cone^ C, Standard_Real UMin, Standard_Real UMax, Standard_Real VMin, Standard_Real VMax);

//! Make a face from a sphere. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Sphere^ S, Standard_Real UMin, Standard_Real UMax, Standard_Real VMin, Standard_Real VMax);

//! Make a face from a torus. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Torus^ C, Standard_Real UMin, Standard_Real UMax, Standard_Real VMin, Standard_Real VMax);

//! Make a face from a Surface. Accepts tolerance value (TolDegen) <br>
//!          for resolution of degenerated edges. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCGeom_Surface^ S, Standard_Real UMin, Standard_Real UMax, Standard_Real VMin, Standard_Real VMax, Standard_Real TolDegen);
...
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean OnlyPlane);

//! Make a face from a plane and a wire. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Pln^ P, OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean Inside);

//! Make a face from a cylinder and a wire. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Cylinder^ C, OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean Inside);

//! Make a face from a cone and a wire. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Cone^ C, OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean Inside);

//! Make a face from a sphere and a wire. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Sphere^ S, OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean Inside);

//! Make a face from a torus and a wire. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCgp_Torus^ C, OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean Inside);

//! Make a face from a Surface and a wire. <br>
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCGeom_Surface^ S, OCNaroWrappers::OCTopoDS_Wire^ W, System::Boolean Inside);
...
OCBRepBuilderAPI_MakeFace(OCNaroWrappers::OCTopoDS_Face^ F, OCNaroWrappers::OCTopoDS_Wire^ W);
...
//!   bounds of the surface. <br>
 /*instead*/  OCBRepBuilderAPI_FaceError Error() ;
