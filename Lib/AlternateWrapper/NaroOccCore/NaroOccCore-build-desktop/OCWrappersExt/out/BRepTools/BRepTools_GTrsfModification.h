...
//
#ifndef _BRepTools_GTrsfModification_OCWrappers_HeaderFile
#define _BRepTools_GTrsfModification_OCWrappers_HeaderFile
...
//!          geometry. <br>
public ref class OCBRepTools_GTrsfModification : OCBRepTools_Modification {

protected:
  // dummy constructor;
  OCBRepTools_GTrsfModification(OCDummy^) : OCBRepTools_Modification((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepTools_GTrsfModification(Handle(BRepTools_GTrsfModification)* nativeHandle);

// Methods PUBLIC


OCBRepTools_GTrsfModification(OCNaroWrappers::OCgp_GTrsf^ T);

//! Gives an access on the GTrsf. <br>
 /*instead*/  OCgp_GTrsf^ GTrsf() ;
