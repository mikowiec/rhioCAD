...
//
#ifndef _BRepLib_FuseEdges_OCWrappers_HeaderFile
#define _BRepLib_FuseEdges_OCWrappers_HeaderFile
...
public ref class OCBRepLib_FuseEdges  {

protected:
  BRepLib_FuseEdges* nativeHandle;
  OCBRepLib_FuseEdges(OCDummy^) {};

public:
  property BRepLib_FuseEdges* Handle
  {
...
OCBRepLib_FuseEdges(BRepLib_FuseEdges* nativeHandle);

// Methods PUBLIC

//! Initialise members  and build  construction of map <br>
//!          of ancestors. <br>
OCBRepLib_FuseEdges(OCNaroWrappers::OCTopoDS_Shape^ theShape, System::Boolean PerformNow);
...
//!  End  Modified  by  IFV  19.04.07 <br>
 /*instead*/  void SetConcatBSpl(System::Boolean theConcatBSpl) ;
