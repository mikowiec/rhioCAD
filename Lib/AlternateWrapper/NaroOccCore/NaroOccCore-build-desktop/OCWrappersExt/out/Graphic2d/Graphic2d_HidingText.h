...
//
#ifndef _Graphic2d_HidingText_OCWrappers_HeaderFile
#define _Graphic2d_HidingText_OCWrappers_HeaderFile
...
public ref class OCGraphic2d_HidingText : OCGraphic2d_Text {

protected:
  // dummy constructor;
  OCGraphic2d_HidingText(OCDummy^) : OCGraphic2d_Text((OCDummy^)nullptr) {};

public:

// constructor from native
OCGraphic2d_HidingText(Handle(Graphic2d_HidingText)* nativeHandle);
...
OCGraphic2d_HidingText(OCNaroWrappers::OCGraphic2d_GraphicObject^ aGraphicObject, OCNaroWrappers::OCTCollection_ExtendedString^ aText, Standard_Real X, Standard_Real Y, Quantity_PlaneAngle anAngle, Quantity_Ratio aMargin, OCAspect_TypeOfText aType, Quantity_Factor aScale);
