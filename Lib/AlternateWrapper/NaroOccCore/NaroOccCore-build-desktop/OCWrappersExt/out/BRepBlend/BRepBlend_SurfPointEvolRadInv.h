...
//
#ifndef _BRepBlend_SurfPointEvolRadInv_OCWrappers_HeaderFile
#define _BRepBlend_SurfPointEvolRadInv_OCWrappers_HeaderFile
...
public ref class OCBRepBlend_SurfPointEvolRadInv  : public OCBlend_SurfPointFuncInv {

protected:
  // dummy constructor;
  OCBRepBlend_SurfPointEvolRadInv(OCDummy^) : OCBlend_SurfPointFuncInv((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepBlend_SurfPointEvolRadInv(BRepBlend_SurfPointEvolRadInv* nativeHandle);

// Methods PUBLIC


OCBRepBlend_SurfPointEvolRadInv(OCNaroWrappers::OCAdaptor3d_HSurface^ S, OCNaroWrappers::OCAdaptor3d_HCurve^ C, OCNaroWrappers::OCLaw_Function^ Evol);
...
~OCBRepBlend_SurfPointEvolRadInv()
{
  delete nativeHandle;
}
