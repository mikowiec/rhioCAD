...
//
#ifndef _BRepBlend_CurvPointRadInv_OCWrappers_HeaderFile
#define _BRepBlend_CurvPointRadInv_OCWrappers_HeaderFile
...
public ref class OCBRepBlend_CurvPointRadInv  : public OCBlend_CurvPointFuncInv {

protected:
  // dummy constructor;
  OCBRepBlend_CurvPointRadInv(OCDummy^) : OCBlend_CurvPointFuncInv((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepBlend_CurvPointRadInv(BRepBlend_CurvPointRadInv* nativeHandle);

// Methods PUBLIC


OCBRepBlend_CurvPointRadInv(OCNaroWrappers::OCAdaptor3d_HCurve^ C1, OCNaroWrappers::OCAdaptor3d_HCurve^ C2);
