...
//
#ifndef _BRepBlend_SurfRstEvolRad_OCWrappers_HeaderFile
#define _BRepBlend_SurfRstEvolRad_OCWrappers_HeaderFile
...
public ref class OCBRepBlend_SurfRstEvolRad  : public OCBlend_SurfRstFunction {

protected:
  // dummy constructor;
  OCBRepBlend_SurfRstEvolRad(OCDummy^) : OCBlend_SurfRstFunction((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepBlend_SurfRstEvolRad(BRepBlend_SurfRstEvolRad* nativeHandle);

// Methods PUBLIC


OCBRepBlend_SurfRstEvolRad(OCNaroWrappers::OCAdaptor3d_HSurface^ Surf, OCNaroWrappers::OCAdaptor3d_HSurface^ SurfRst, OCNaroWrappers::OCAdaptor2d_HCurve2d^ Rst, OCNaroWrappers::OCAdaptor3d_HCurve^ CGuide, OCNaroWrappers::OCLaw_Function^ Evol);
