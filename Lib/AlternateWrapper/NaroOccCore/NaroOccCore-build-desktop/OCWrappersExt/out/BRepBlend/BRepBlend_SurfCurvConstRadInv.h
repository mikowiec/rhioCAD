...
//
#ifndef _BRepBlend_SurfCurvConstRadInv_OCWrappers_HeaderFile
#define _BRepBlend_SurfCurvConstRadInv_OCWrappers_HeaderFile
...
//!          the surface. <br>
public ref class OCBRepBlend_SurfCurvConstRadInv  : public OCBlend_SurfCurvFuncInv {

protected:
  // dummy constructor;
  OCBRepBlend_SurfCurvConstRadInv(OCDummy^) : OCBlend_SurfCurvFuncInv((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepBlend_SurfCurvConstRadInv(BRepBlend_SurfCurvConstRadInv* nativeHandle);

// Methods PUBLIC


OCBRepBlend_SurfCurvConstRadInv(OCNaroWrappers::OCAdaptor3d_HSurface^ S, OCNaroWrappers::OCAdaptor3d_HCurve^ C, OCNaroWrappers::OCAdaptor3d_HCurve^ Cg);
...
~OCBRepBlend_SurfCurvConstRadInv()
{
  delete nativeHandle;
}
