...
//
#ifndef _BRepBlend_HCurveTool_OCWrappers_HeaderFile
#define _BRepBlend_HCurveTool_OCWrappers_HeaderFile
...
public ref class OCBRepBlend_HCurveTool  {

protected:
  BRepBlend_HCurveTool* nativeHandle;
  OCBRepBlend_HCurveTool(OCDummy^) {};

public:
  property BRepBlend_HCurveTool* Handle
  {
    BRepBlend_HCurveTool* get()
    {
      return nativeHandle;
    }
  }
...
OCBRepBlend_HCurveTool(BRepBlend_HCurveTool* nativeHandle);
