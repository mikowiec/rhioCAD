...
//
#ifndef _BRepBlend_RstRstConstRad_OCWrappers_HeaderFile
#define _BRepBlend_RstRstConstRad_OCWrappers_HeaderFile
...
public ref class OCBRepBlend_RstRstConstRad  : public OCBlend_RstRstFunction {

protected:
  // dummy constructor;
  OCBRepBlend_RstRstConstRad(OCDummy^) : OCBlend_RstRstFunction((OCDummy^)nullptr) {};

public:

// constructor from native
OCBRepBlend_RstRstConstRad(BRepBlend_RstRstConstRad* nativeHandle);

// Methods PUBLIC


OCBRepBlend_RstRstConstRad(OCNaroWrappers::OCAdaptor3d_HSurface^ Surf1, OCNaroWrappers::OCAdaptor2d_HCurve2d^ Rst1, OCNaroWrappers::OCAdaptor3d_HSurface^ Surf2, OCNaroWrappers::OCAdaptor2d_HCurve2d^ Rst2, OCNaroWrappers::OCAdaptor3d_HCurve^ CGuide);
