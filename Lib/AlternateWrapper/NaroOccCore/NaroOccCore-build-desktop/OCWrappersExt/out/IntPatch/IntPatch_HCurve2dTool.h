...
//
#ifndef _IntPatch_HCurve2dTool_OCWrappers_HeaderFile
#define _IntPatch_HCurve2dTool_OCWrappers_HeaderFile
...
public ref class OCIntPatch_HCurve2dTool  {

protected:
  IntPatch_HCurve2dTool* nativeHandle;
  OCIntPatch_HCurve2dTool(OCDummy^) {};

public:
  property IntPatch_HCurve2dTool* Handle
  {
    IntPatch_HCurve2dTool* get()
    {
      return nativeHandle;
    }
  }
...
OCIntPatch_HCurve2dTool(IntPatch_HCurve2dTool* nativeHandle);
