...
//
#ifndef _IntPatch_HSurfaceTool_OCWrappers_HeaderFile
#define _IntPatch_HSurfaceTool_OCWrappers_HeaderFile
...
public ref class OCIntPatch_HSurfaceTool  {

protected:
  IntPatch_HSurfaceTool* nativeHandle;
  OCIntPatch_HSurfaceTool(OCDummy^) {};

public:
  property IntPatch_HSurfaceTool* Handle
  {
    IntPatch_HSurfaceTool* get()
    {
      return nativeHandle;
    }
  }
...
OCIntPatch_HSurfaceTool(IntPatch_HSurfaceTool* nativeHandle);
