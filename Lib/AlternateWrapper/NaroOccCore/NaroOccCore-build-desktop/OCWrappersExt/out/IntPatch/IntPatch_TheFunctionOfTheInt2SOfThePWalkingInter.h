...
//
#ifndef _IntPatch_TheFunctionOfTheInt2SOfThePWalkingInter_OCWrappers_HeaderFile
#define _IntPatch_TheFunctionOfTheInt2SOfThePWalkingInter_OCWrappers_HeaderFile
...
public ref class OCIntPatch_TheFunctionOfTheInt2SOfThePWalkingInter  : public OCmath_FunctionSetWithDerivatives {

protected:
  // dummy constructor;
  OCIntPatch_TheFunctionOfTheInt2SOfThePWalkingInter(OCDummy^) : OCmath_FunctionSetWithDerivatives((OCDummy^)nullptr) {};

public:

// constructor from native
OCIntPatch_TheFunctionOfTheInt2SOfThePWalkingInter(IntPatch_TheFunctionOfTheInt2SOfThePWalkingInter* nativeHandle);
...
OCIntPatch_TheFunctionOfTheInt2SOfThePWalkingInter(OCNaroWrappers::OCAdaptor3d_HSurface^ S1, OCNaroWrappers::OCAdaptor3d_HSurface^ S2);
