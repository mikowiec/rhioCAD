...
//
#ifndef _TopExp_Explorer_OCWrappers_HeaderFile
#define _TopExp_Explorer_OCWrappers_HeaderFile
...
//! <br>
public ref class OCTopExp_Explorer  {

protected:
  TopExp_Explorer* nativeHandle;
  OCTopExp_Explorer(OCDummy^) {};

public:
  property TopExp_Explorer* Handle
  {
    TopExp_Explorer* get()
    {
      return nativeHandle;
...
OCTopExp_Explorer(TopExp_Explorer* nativeHandle);
...
//! <br>
OCTopExp_Explorer(OCNaroWrappers::OCTopoDS_Shape^ S, OCTopAbs_ShapeEnum ToFind, OCTopAbs_ShapeEnum ToAvoid);
