...
#ifndef _BRepGProp_OCWrappers_HeaderFile
#define _BRepGProp_OCWrappers_HeaderFile
...
public ref class OCBRepGProp abstract sealed
{
...
static /*instead*/  void LinearProperties(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ LProps) ;
...
static /*instead*/  void SurfaceProperties(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ SProps) ;
...
static /*instead*/  Standard_Real SurfaceProperties(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ SProps, Standard_Real Eps) ;


static /*instead*/  void VolumeProperties(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ VProps, System::Boolean OnlyClosed) ;
...
//!          Method returns estimation of relative error reached for whole shape. <br>
//!          WARNING: if Eps > 0.001 algorithm performs non-adaptive integration. <br>
static /*instead*/  Standard_Real VolumeProperties(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ VProps, Standard_Real Eps, System::Boolean OnlyClosed) ;
...
static /*instead*/  Standard_Real VolumePropertiesGK(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ VProps, Standard_Real Eps, System::Boolean OnlyClosed, System::Boolean IsUseSpan, System::Boolean CGFlag, System::Boolean IFlag) ;


static /*instead*/  Standard_Real VolumePropertiesGK(OCNaroWrappers::OCTopoDS_Shape^ S, OCNaroWrappers::OCGProp_GProps^ VProps, OCNaroWrappers::OCgp_Pln^ thePln, Standard_Real Eps, System::Boolean OnlyClosed, System::Boolean IsUseSpan, System::Boolean CGFlag, System::Boolean IFlag) ;
