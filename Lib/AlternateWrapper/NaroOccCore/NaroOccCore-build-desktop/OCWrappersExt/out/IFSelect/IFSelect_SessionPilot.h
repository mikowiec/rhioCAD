...
//
#ifndef _IFSelect_SessionPilot_OCWrappers_HeaderFile
#define _IFSelect_SessionPilot_OCWrappers_HeaderFile
...
public ref class OCIFSelect_SessionPilot : OCIFSelect_Activator {

protected:
  // dummy constructor;
  OCIFSelect_SessionPilot(OCDummy^) : OCIFSelect_Activator((OCDummy^)nullptr) {};

public:

// constructor from native
OCIFSelect_SessionPilot(Handle(IFSelect_SessionPilot)* nativeHandle);
...
//!           Empty string if out of range <br>
 /*instead*/  System::String^ CommandPart(Standard_Integer numarg) ;
...
//!           Remark : it is nullified for each Perform <br>
 /*instead*/  OCIFSelect_ReturnStatus RecordItem(OCNaroWrappers::OCStandard_Transient^ item) ;

//! Returns the Transient Object which was recorded with the <br>
//!           current Line Command. If none was, returns a Null Handle <br>
 /*instead*/  OCStandard_Transient^ RecordedItem() ;
...
//!           RetFail if script could not be opened <br>
 /*instead*/  OCIFSelect_ReturnStatus ReadScript(System::String^ file) ;
...
//!           recorded to the list (see below). <br>
 /*instead*/  OCIFSelect_ReturnStatus Perform() ;
...
//!           Error status is returned if the alias is unknown as command <br>
 /*instead*/  OCIFSelect_ReturnStatus ExecuteAlias(OCNaroWrappers::OCTCollection_AsciiString^ aliasname) ;

//! Sets the Command then tries to execute it. Return value : <br>
//!           same as for Perform <br>
 /*instead*/  OCIFSelect_ReturnStatus Execute(OCNaroWrappers::OCTCollection_AsciiString^ command) ;
...
//!           CountByItem <br>
 /*instead*/  OCIFSelect_ReturnStatus ExecuteCounter(OCNaroWrappers::OCIFSelect_SignCounter^ counter, Standard_Integer numword, OCIFSelect_PrintCount mode) ;
...
//!           in case of failure, returns 0 <br>
 /*instead*/  Standard_Integer Number(System::String^ val) ;
...
//!           xset control commands which create items with names <br>
 /*instead*/  OCIFSelect_ReturnStatus Do(Standard_Integer number, OCNaroWrappers::OCIFSelect_SessionPilot^ session) ;

//! Help for specific commands (apart from general command help) <br>
 /*instead*/  System::String^ Help(Standard_Integer number) ;

~OCIFSelect_SessionPilot()
{
