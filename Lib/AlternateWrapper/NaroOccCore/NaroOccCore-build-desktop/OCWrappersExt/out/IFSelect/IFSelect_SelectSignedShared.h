...
//
#ifndef _IFSelect_SelectSignedShared_OCWrappers_HeaderFile
#define _IFSelect_SelectSignedShared_OCWrappers_HeaderFile
...
public ref class OCIFSelect_SelectSignedShared : OCIFSelect_SelectExplore {

protected:
  // dummy constructor;
  OCIFSelect_SelectSignedShared(OCDummy^) : OCIFSelect_SelectExplore((OCDummy^)nullptr) {};

public:

// constructor from native
OCIFSelect_SelectSignedShared(Handle(IFSelect_SelectSignedShared)* nativeHandle);

// Methods PUBLIC

//! Creates a SelectSignedShared, defaulted for any level <br>
//!           with a given Signature and text to match <br>
OCIFSelect_SelectSignedShared(OCNaroWrappers::OCIFSelect_Signature^ matcher, System::String^ signtext, System::Boolean exact, Standard_Integer level);
