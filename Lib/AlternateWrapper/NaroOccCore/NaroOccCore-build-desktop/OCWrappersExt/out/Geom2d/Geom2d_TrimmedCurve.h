...
//
#ifndef _Geom2d_TrimmedCurve_OCWrappers_HeaderFile
#define _Geom2d_TrimmedCurve_OCWrappers_HeaderFile
...
public ref class OCGeom2d_TrimmedCurve : OCGeom2d_BoundedCurve {

protected:
  // dummy constructor;
  OCGeom2d_TrimmedCurve(OCDummy^) : OCGeom2d_BoundedCurve((OCDummy^)nullptr) {};

public:

// constructor from native
OCGeom2d_TrimmedCurve(Handle(Geom2d_TrimmedCurve)* nativeHandle);
...
//!  the bounds of C. <br>
//!  Raised if U1 = U2. <br>
OCGeom2d_TrimmedCurve(OCNaroWrappers::OCGeom2d_Curve^ C, Standard_Real U1, Standard_Real U2, System::Boolean Sense);
