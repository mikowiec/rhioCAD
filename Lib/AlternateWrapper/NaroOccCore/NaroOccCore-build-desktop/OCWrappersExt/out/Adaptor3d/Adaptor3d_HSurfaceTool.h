...
//
#ifndef _Adaptor3d_HSurfaceTool_OCWrappers_HeaderFile
#define _Adaptor3d_HSurfaceTool_OCWrappers_HeaderFile
...
public ref class OCAdaptor3d_HSurfaceTool  {

protected:
  Adaptor3d_HSurfaceTool* nativeHandle;
  OCAdaptor3d_HSurfaceTool(OCDummy^) {};

public:
  property Adaptor3d_HSurfaceTool* Handle
  {
...
OCAdaptor3d_HSurfaceTool(Adaptor3d_HSurfaceTool* nativeHandle);
