...
#ifndef _Quantity_PhysicalQuantity_OCWrappers_HeaderFile
#define _Quantity_PhysicalQuantity_OCWrappers_HeaderFile

namespace OCNaroWrappers
{


public enum class OCQuantity_PhysicalQuantity
{ 
 Quantity_MASS,
Quantity_PLANEANGLE,
Quantity_SOLIDANGLE,
