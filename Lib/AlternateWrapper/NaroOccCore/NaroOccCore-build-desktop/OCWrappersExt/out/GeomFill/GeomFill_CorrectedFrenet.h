...
//
#ifndef _GeomFill_CorrectedFrenet_OCWrappers_HeaderFile
#define _GeomFill_CorrectedFrenet_OCWrappers_HeaderFile
...
public ref class OCGeomFill_CorrectedFrenet : OCGeomFill_TrihedronLaw {

protected:
  // dummy constructor;
  OCGeomFill_CorrectedFrenet(OCDummy^) : OCGeomFill_TrihedronLaw((OCDummy^)nullptr) {};

public:

// constructor from native
OCGeomFill_CorrectedFrenet(Handle(GeomFill_CorrectedFrenet)* nativeHandle);

// Methods PUBLIC


OCGeomFill_CorrectedFrenet();
