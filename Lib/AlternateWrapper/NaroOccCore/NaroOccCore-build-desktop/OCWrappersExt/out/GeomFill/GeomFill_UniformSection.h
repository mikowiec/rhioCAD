...
//
#ifndef _GeomFill_UniformSection_OCWrappers_HeaderFile
#define _GeomFill_UniformSection_OCWrappers_HeaderFile
...
public ref class OCGeomFill_UniformSection : OCGeomFill_SectionLaw {

protected:
  // dummy constructor;
  OCGeomFill_UniformSection(OCDummy^) : OCGeomFill_SectionLaw((OCDummy^)nullptr) {};

public:

// constructor from native
OCGeomFill_UniformSection(Handle(GeomFill_UniformSection)* nativeHandle);

// Methods PUBLIC

//! Make an constant Law with C. <br>
//! [First, Last] define law definition domain <br>
OCGeomFill_UniformSection(OCNaroWrappers::OCGeom_Curve^ C, Standard_Real FirstParameter, Standard_Real LastParameter);
