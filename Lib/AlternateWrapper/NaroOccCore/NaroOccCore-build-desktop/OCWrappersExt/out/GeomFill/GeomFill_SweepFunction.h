...
//
#ifndef _GeomFill_SweepFunction_OCWrappers_HeaderFile
#define _GeomFill_SweepFunction_OCWrappers_HeaderFile
...
public ref class OCGeomFill_SweepFunction : OCApprox_SweepFunction {

protected:
  // dummy constructor;
  OCGeomFill_SweepFunction(OCDummy^) : OCApprox_SweepFunction((OCDummy^)nullptr) {};

public:

// constructor from native
OCGeomFill_SweepFunction(Handle(GeomFill_SweepFunction)* nativeHandle);

// Methods PUBLIC


OCGeomFill_SweepFunction(OCNaroWrappers::OCGeomFill_SectionLaw^ Section, OCNaroWrappers::OCGeomFill_LocationLaw^ Location, Standard_Real FirstParameter, Standard_Real FirstParameterOnS, Standard_Real RatioParameterOnS);
