...
//
#ifndef _GeomFill_LocationDraft_OCWrappers_HeaderFile
#define _GeomFill_LocationDraft_OCWrappers_HeaderFile
...
ref class OCGeomFill_DraftTrihedron;
...
public ref class OCGeomFill_LocationDraft : OCGeomFill_LocationLaw {

protected:
  // dummy constructor;
  OCGeomFill_LocationDraft(OCDummy^) : OCGeomFill_LocationLaw((OCDummy^)nullptr) {};

public:

// constructor from native
OCGeomFill_LocationDraft(Handle(GeomFill_LocationDraft)* nativeHandle);

// Methods PUBLIC


OCGeomFill_LocationDraft(OCNaroWrappers::OCgp_Dir^ Direction, Standard_Real Angle);


 /*instead*/  void SetStopSurf(OCNaroWrappers::OCAdaptor3d_HSurface^ Surf) ;
...
//! Say if the generatrice interset the surface <br>
 /*instead*/  System::Boolean IsIntersec() ;
