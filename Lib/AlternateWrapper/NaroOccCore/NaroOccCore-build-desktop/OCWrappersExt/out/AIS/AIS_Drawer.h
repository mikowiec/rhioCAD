...
//
#ifndef _AIS_Drawer_OCWrappers_HeaderFile
#define _AIS_Drawer_OCWrappers_HeaderFile
...
public ref class OCAIS_Drawer : OCPrs3d_Drawer {

protected:
  // dummy constructor;
  OCAIS_Drawer(OCDummy^) : OCPrs3d_Drawer((OCDummy^)nullptr) {};

public:

// constructor from native
OCAIS_Drawer(Handle(AIS_Drawer)* nativeHandle);
...
virtual /*instead*/  OCAspect_TypeOfDeflection TypeOfDeflection() override;
...
virtual /*instead*/  Quantity_Length MaximalChordialDeviation() override;

//! Sets the hasOwnDeviationCoefficient flag to Standard_False <br>
 /*instead*/  void SetDeviationCoefficient() ;
...
//! viewpoints in different presentations. The Default value is 0.02. <br>
 /*instead*/  void SetHLRDeviationCoefficient() ;

//! Sets the hasOwnDeviationAngle flag to Standard_False <br>
 /*instead*/  void SetDeviationAngle() ;
...
virtual /*instead*/  void SetDeviationCoefficient(Standard_Real aCoefficient) override;
...
virtual /*instead*/  Standard_Real DeviationCoefficient() override;
...
//! coefficient in this framework for a specific interactive object. <br>
 /*instead*/  System::Boolean IsOwnDeviationCoefficient() ;

//! Returns true if the there is a setting for HLR deviation <br>
//! coefficient in this framework for a specific interactive object. <br>
 /*instead*/  System::Boolean IsOwnHLRDeviationCoefficient() ;

//! Returns true if the there is a local setting for deviation <br>
//! angle in this framework for a specific interactive object. <br>
 /*instead*/  System::Boolean IsOwnDeviationAngle() ;

//! Returns true if the there is a setting for HLR deviation <br>
//! angle in this framework for a specific interactive object. <br>
 /*instead*/  System::Boolean IsOwnHLRDeviationAngle() ;
...
virtual /*instead*/  Standard_Integer Discretisation() override;
...
virtual /*instead*/  Standard_Real MaximalParameterValue() override;

//! returns True if the drawing of isos on planes is enabled. <br>
virtual /*instead*/  System::Boolean IsoOnPlane() override;
...
virtual /*instead*/  OCPrs3d_IsoAspect^ UIsoAspect() override;
...
//!          Prs3d_WFDeflectionSurface <br>
//!          Prs3d_WFDeflectionRestrictedFace <br>
virtual /*instead*/  OCPrs3d_IsoAspect^ VIsoAspect() override;
...
virtual /*instead*/  OCPrs3d_LineAspect^ FreeBoundaryAspect() override;

//! returns True if the drawing of the free boundaries is enabled. <br>
virtual /*instead*/  System::Boolean FreeBoundaryDraw() override;
...
virtual /*instead*/  System::Boolean WireDraw() override;
...
//!          These attributes are used by the following algorithms: <br>
//!          Prs3d_WFShape <br>
virtual /*instead*/  OCPrs3d_LineAspect^ UnFreeBoundaryAspect() override;

//! Returns True if the drawing of the shared boundaries <br>
//! is enabled. True is the default setting. <br>
virtual /*instead*/  System::Boolean UnFreeBoundaryDraw() override;
...
//!          Prs3d_Line <br>
//!          Prs3d_HLRShape <br>
virtual /*instead*/  OCPrs3d_LineAspect^ LineAspect() override;


 /*instead*/  System::Boolean HasTextAspect() ;


virtual /*instead*/  OCPrs3d_TextAspect^ TextAspect() override;

//! Returns True if the drawing of an arrow at the end of <br>
//! each line is enabled. The default setting is False. <br>
virtual /*instead*/  System::Boolean LineArrowDraw() override;


virtual /*instead*/  OCPrs3d_ArrowAspect^ ArrowAspect() override;
...
//!          These attributes are used by the following algorithms: <br>
//!          Prs3d_Point <br>
virtual /*instead*/  OCPrs3d_PointAspect^ PointAspect() override;

//! Returns true if the Drawer has a point aspect setting active. <br>
 /*instead*/  System::Boolean HasPointAspect() ;
...
virtual /*instead*/  OCPrs3d_ShadingAspect^ ShadingAspect() override;

//! Returns True if the   Drawer has shading aspect active. <br>
 /*instead*/  System::Boolean HasShadingAspect() ;

//! Provides the attributes for hidden line removal. <br>
virtual /*instead*/  System::Boolean ShadingAspectGlobal() override;

//! Returns Standard_True if the hidden lines are to be drawn. <br>
//!          By default the hidden lines are not drawn. <br>
virtual /*instead*/  System::Boolean DrawHiddenLine() override;
...
//!          Width: 1. <br>
virtual /*instead*/  OCPrs3d_LineAspect^ HiddenLineAspect() override;
...
//!          Type of line: Aspect_TOL_SOLID <br>
//!          Width: 1. <br>
virtual /*instead*/  OCPrs3d_LineAspect^ SeenLineAspect() override;


 /*instead*/  System::Boolean HasPlaneAspect() ;


//! Returns a link with Prs3d_Drawer_PlaneAspect. <br>
//! This method provides settings for the appearance of planes. <br>
virtual /*instead*/  OCPrs3d_PlaneAspect^ PlaneAspect() override;
...
//!          Type of line: Aspect_TOL_SOLID Width: 1. <br>
virtual /*instead*/  OCPrs3d_LineAspect^ VectorAspect() override;
...
//! drawn or not. <br>
virtual /*instead*/  void SetFaceBoundaryDraw(System::Boolean theIsEnabled) override;

//! Checks whether the drawing of face boundaries is enabled or not. <br>
virtual /*instead*/  System::Boolean IsFaceBoundaryDraw() override;
...
virtual /*instead*/  void SetFaceBoundaryAspect(OCNaroWrappers::OCPrs3d_LineAspect^ theAspect) override;

//! Returns line aspect of face boundaries. <br>
virtual /*instead*/  OCPrs3d_LineAspect^ FaceBoundaryAspect() override;

//! Returns true if the drawer has its own attribute for <br>
//! "draw face boundaries" flag that overrides the one in the link. <br>
 /*instead*/  System::Boolean IsOwnFaceBoundaryDraw() ;

//! Returns true if the drawer has its own attribute for <br>
//! face boundaries aspect that overrides the one in the link. <br>
 /*instead*/  System::Boolean IsOwnFaceBoundaryAspect() ;


 /*instead*/  System::Boolean HasDatumAspect() ;
...
//! These attributes are used by the following algorithms: <br>
//! Prs3d_WFShape <br>
virtual /*instead*/  OCPrs3d_LineAspect^ SectionAspect() override;


 /*instead*/  OCPrs3d_Drawer^ Link() ;


 /*instead*/  System::Boolean HasLink() ;


 /*instead*/  void Link(OCNaroWrappers::OCPrs3d_Drawer^ aDrawer) ;

//! Removes attributes stored in a Local Context. <br>
virtual /*instead*/  void ClearLocalAttributes() ;

//! Returns true if the last called attribute was local; false if it was global. <br>
 /*instead*/  System::Boolean WasLastLocal() ;


//! Returns true if a Local Context has stored attributes <br>
//! for Interactive Objects. <br>
 /*instead*/  System::Boolean HasLocalAttributes() ;
