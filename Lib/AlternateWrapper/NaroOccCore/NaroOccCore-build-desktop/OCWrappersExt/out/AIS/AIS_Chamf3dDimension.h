...
//
#ifndef _AIS_Chamf3dDimension_OCWrappers_HeaderFile
#define _AIS_Chamf3dDimension_OCWrappers_HeaderFile
...
public ref class OCAIS_Chamf3dDimension : OCAIS_Relation {

protected:
  // dummy constructor;
  OCAIS_Chamf3dDimension(OCDummy^) : OCAIS_Relation((OCDummy^)nullptr) {};

public:

// constructor from native
OCAIS_Chamf3dDimension(Handle(AIS_Chamf3dDimension)* nativeHandle);
...
OCAIS_Chamf3dDimension(OCNaroWrappers::OCTopoDS_Shape^ aFShape, Standard_Real aVal, OCNaroWrappers::OCTCollection_ExtendedString^ aText);
...
OCAIS_Chamf3dDimension(OCNaroWrappers::OCTopoDS_Shape^ aFShape, Standard_Real aVal, OCNaroWrappers::OCTCollection_ExtendedString^ aText, OCNaroWrappers::OCgp_Pnt^ aPosition, OCDsgPrs_ArrowSide aSymbolPrs, Standard_Real anArrowSize);
