...
#ifndef _Precision_OCWrappers_HeaderFile
#define _Precision_OCWrappers_HeaderFile
...
public ref class OCPrecision abstract sealed
{
...
static /*instead*/  Standard_Real Angular() ;
...
static /*instead*/  Standard_Real Confusion() ;


//! Returns square of Confusion. <br>
//! Created for speed and convenience. <br>
static /*instead*/  Standard_Real SquareConfusion() ;
...
//! (that is, 1.e-9). <br>
static /*instead*/  Standard_Real Intersection() ;
...
static /*instead*/  Standard_Real Approximation() ;
...
//!          Value is P / T <br>
//! <br>
static /*instead*/  Standard_Real Parametric(Standard_Real P, Standard_Real T) ;
...
static /*instead*/  Standard_Real PConfusion(Standard_Real T) ;
...
static /*instead*/  Standard_Real PIntersection(Standard_Real T) ;
...
static /*instead*/  Standard_Real PApproximation(Standard_Real T) ;
...
//! <br>
static /*instead*/  Standard_Real Parametric(Standard_Real P) ;
...
//! <br>
static /*instead*/  Standard_Real PConfusion() ;
...
//! <br>
static /*instead*/  Standard_Real PIntersection() ;
