...
//
#ifndef _StepBasic_IdentificationRole_OCWrappers_HeaderFile
#define _StepBasic_IdentificationRole_OCWrappers_HeaderFile
...
public ref class OCStepBasic_IdentificationRole : OCMMgt_TShared {

protected:
  // dummy constructor;
  OCStepBasic_IdentificationRole(OCDummy^) : OCMMgt_TShared((OCDummy^)nullptr) {};

public:

// constructor from native
OCStepBasic_IdentificationRole(Handle(StepBasic_IdentificationRole)* nativeHandle);

// Methods PUBLIC

//! Empty constructor <br>
OCStepBasic_IdentificationRole();
