namespace ZetaColorEditor.Runtime.InternalControls
{
	...
	public partial class SystemColorEditorUserControl :
		UserControl
	{
		...
		private void systemColorEditorUserControl_Load(
			object sender,
			EventArgs e )
		{
			checkEnsureFilled();
		...
		private void colorsListView_SizeChanged(
			object sender,
			EventArgs e )
		{
		...
		private void checkEnsureFilled()
		{
			if ( colorsListView.Items.Count <= 0 )
			{
				...
				var members =
					typeof( SystemColors ).GetProperties(
