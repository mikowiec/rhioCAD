...
{
    /// <summary>
    ///   Applies a fillet feature on a shelected shape.
    /// </summary>
    public class Fillet : ChamferFilletBaseAction
    {
        private SceneSelectedEntity _selectedNode;

        public Fillet() : base(ModifierNames.Fillet)
        {
        }
        ...
        protected override void PreviewFillet()
        {
            ...
            Builder[3].Integer = (int) FilletChamferTypes.SimpleFillet;
