...
{
    public class RectangleWidthConstraint : FunctionBase
    {
        public RectangleWidthConstraint() : base(FunctionNames.RectangleWidthConstraint)
        {
        ...
        public override bool Execute()
        {
            ...
            TreeUtils.RectangleSetWidth(rectangleNode, recctangleNewRangeValue);
