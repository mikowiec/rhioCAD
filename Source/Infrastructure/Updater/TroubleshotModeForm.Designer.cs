...
namespace Updater
{
	partial class TroubleshotModeForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.buttonPanel.Size = new System.Drawing.Size(292, 50);
			...
			this.cancelButton.Location = new System.Drawing.Point(92, 12);
			...
			this.okButton.Location = new System.Drawing.Point(192, 12);
			...
			this.glassPanel1.Size = new System.Drawing.Size(292, 271);
			...
			this.label1.Text = "This will install the latest version from internet and overwrite your current ins" +
			"tall!";
			// 
			// TroubleshotModeForm
			// 
			...
			this.Name = "TroubleshotModeForm";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.Text = "Troubleshot Mode";
